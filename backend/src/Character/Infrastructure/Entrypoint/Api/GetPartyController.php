...
#[AsController]
#[Route("/api/party/{partyId}", name: "api_party_get", methods: ['GET'])]
final class GetPartyController
{
    public function __construct(private readonly FindPartyByIdQueryHandler $useCase)
    {
    }
    ...
    {
        try {
            $query = new FindPartyByIdQuery($partyId);
