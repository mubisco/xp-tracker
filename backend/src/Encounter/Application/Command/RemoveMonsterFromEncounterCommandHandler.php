...
final class RemoveMonsterFromEncounterCommandHandler implements CommandHandlerInterface
{
    ...
    public function __invoke(RemoveMonsterFromEncounterCommand $command): void
    {
