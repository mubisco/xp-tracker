...
final class UnassignPartyToEncounterCommandHandler implements CommandHandlerInterface
{
    ...
    public function __invoke(UnassignPartyToEncounterCommand $command): void
    {
