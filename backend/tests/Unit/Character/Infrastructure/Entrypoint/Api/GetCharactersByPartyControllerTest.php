...
use XpTracker\Character\Infrastructure\Entrypoint\Api\GetCharactersByPartyController;

class GetCharactersByPartyControllerTest extends TestCase
{
    private GetCharactersByPartyController $sut;
    private CharactersByPartyQueryHandler&Stub $useCase;

    protected function setUp(): void
    {
        $this->useCase = $this->createStub(CharactersByPartyQueryHandler::class);
        $this->sut = new GetCharactersByPartyController($this->useCase);
    }
    /** @test */
