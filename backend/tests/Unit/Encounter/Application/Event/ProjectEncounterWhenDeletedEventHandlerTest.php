...
use XpTracker\Encounter\Application\Event\ProjectEncounterWhenDeletedEventHandler;
...
class ProjectEncounterWhenDeletedEventHandlerTest extends TestCase
{
    public function testItShouldThrowExceptionWhenWrongUlid(): void
    {
        $this->expectException(WrongEncounterUlidException::class);
        $event = new EncounterWasDeleted(encounterUlid: 'asd');
        $sut = new ProjectEncounterWhenDeletedEventHandler(
    ...
    public function testItShouldThrowExceptionIfNoCharacterFound(): void
    {
        ...
        $event = new EncounterWasDeleted(encounterUlid: '01HWV4RPY89PJ1H3JS9267TNFH');
        $sut = new ProjectEncounterWhenDeletedEventHandler(
            new EncounterRepositoryNotFoundStub(),
            new EncounterProjectionFailingStub()
        );
